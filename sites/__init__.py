...
films = [
	"altadefinizione2", "altadefinizione3", "altadefinizione4", "altadefinizione5",
	"altadefinizione6", "altadefinizione7", "cineblog01", "ilgeniodellostreaming2",
	"piratestreaming"
]

serietvs = [
	"eurostreaming1", "italiaserie", "piratestreaming", "serietvu"
]
